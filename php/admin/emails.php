...
<div class="container">
    ...
    <div class="main-content">
        ...
        <!-- Table for Contact Us Submissions -->
        <div class="enrollees">
            <a class="titlesss">Contact Us Submissions</a>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><button class='check' onclick='markAsDone(" . $row['id'] . ")'>✔</button></td>";
                            echo "</tr>";
                        }
                    } else {
                        echo "<tr><td colspan='8' class='text-center'>No submissions found</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'accept') {
        ...
        $sql = "UPDATE contactus SET status = 'Done' WHERE id = ?";
    }
